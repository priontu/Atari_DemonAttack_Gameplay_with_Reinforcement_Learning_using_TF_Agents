...
# Assigning game and environment names:
game_name = "DemonAttack-v4"
environment_name = "DemonAttackNoFrameskip-v4"

# Making directories for saving results:
PROJECT_ROOT_DIR = "."
...
epsilon_fn = keras.optimizers.schedules.PolynomialDecay(
    ...
    decay_steps=1_000// update_period, # <=> 1,000,000 ALE frames
...
# Creating checkpointer with parameters:
...
# Saving the policies and models, and updating checkpoint:
